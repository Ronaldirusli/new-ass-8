...
```
Nama: Ronaldi Rusli
Repository: https://github.com/Ronaldirusli/new-ass-8.git
Deployment: https://vercel.com/ronaldi-s-projects/new-ass-8/GUhAYJgyNEQMSM9RqrpzsVasEAdA
Notes: sy berusaha maksimal utk deploy ini. semoga diterima. thankyou.
```
